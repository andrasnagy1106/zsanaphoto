/**
 * Hungarian postal codes dictionary mapping 4-digit zip codes (outside Budapest) to settlement names.
 * Source: GeoNames Hungarian postal dataset.
 */
export const HUNGARIAN_POSTAL_CODES: Record<string, string> = {
  "2000": "Szentendre",
...
/**
 * Resolves a Hungarian settlement / city name by 4-digit postal code.
 * Returns "Budapest" for 1xxx codes, mapped city name for known postal codes, or null if unknown.
 */
export function getHungarianCityByPostalCode(postalCode: string): string | null {
